...
import { LinkedIn, GitHub, Instagram, Email, Download } from '@mui/icons-material'
...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 pt-24">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between w-full max-w-7xl mx-auto px-6">
        ...
        <motion.div 
          className="flex flex-col items-center lg:items-start lg:w-1/2 text-center lg:text-left"
        ...
        >
          ...
          <motion.h1
            variants={itemVariants}
            className="text-5xl lg:text-7xl font-bold text-white mb-4 gradient-text"
          >
            Jannelson
          </motion.h1>
          ...
          <motion.div
            variants={itemVariants}
            className="text-2xl lg:text-4xl font-semibold text-yellow-400 mb-6 h-12"
          >
          ...
          >
            {[
              { icon: GitHub, href: "https://github.com/jannelson36", color: "hover:text-gray-400" },
              { icon: LinkedIn, href: "https://linkedin.com/in/jannelson36", color: "hover:text-blue-400" },
              { icon: Instagram, href: "https://instagram.com/jannelson36", color: "hover:text-pink-400" },
              { icon: Email, href: "mailto:contact@jannelson36.dev", color: "hover:text-green-400" }
